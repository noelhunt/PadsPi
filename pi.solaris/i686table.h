/* <MESA:01:@(#):Mdruhi9BHCJ0:bug:1.1:900523133828:druhi:1 35 3619:MESA> */
...
static const char *regname16[4][8] = {
...
static const char *regname32[4][8] = {
/*reg   000       001       010       011       100       101       110       111 */
/*mod*/
...
static const char *scale_factor[4] = {
	"1",
	"2",
	"4",
	"8"
...
static const char *DEBUGREG[8] = {
	"%db0", "%db1", "%db2", "%db3", "%db4", "%db5", "%db6", "%db7"
};

static const char *CONTROLREG[8] = {
	"%cr0", "%cr1", "%cr2", "%cr3", "%cr4?", "%cr5?", "%cr6?", "%cr7?"
};

static const char *TESTREG[8] = {
...
static struct instable op0F00[8] = {
...
static struct instable op0F01[8] = {
...
static struct instable op0FBA[8] = {
...
static struct instable op0F[12][16] = {
...
static struct instable opFP1n2[8][8] = {
...
static struct instable opFP3[8][8] = {
...
static struct instable opFP4[4][8] = {
...
static struct instable opFP5[8] = {
...
/* [0,C] */	{"orb",TERM,IA,0},	{"or",TERM,IA,1},	{"push",TERM,SEG,1},	{"",(instable*)op0F,TERM,0},
...
/* [D,8] */	{"",(instable*)opFP1n2,TERM,0},	{"",(instable*)opFP1n2,TERM,0},	{"",(instable*)opFP1n2,TERM,0},	{"",(instable*)opFP1n2,TERM,0},
/* [D,C] */	{"",(instable*)opFP1n2,TERM,0},	{"",(instable*)opFP1n2,TERM,0},	{"",(instable*)opFP1n2,TERM,0},	{"",(instable*)opFP1n2,TERM,0},
